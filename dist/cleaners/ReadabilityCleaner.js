...
exports.ReadabilityCleaner = void 0;
const readability_1 = require("@mozilla/readability");
const jsdom_1 = require("jsdom");
const BaseTextCleaner_1 = require("./BaseTextCleaner");
const ITextCleaner_1 = require("../interfaces/ITextCleaner");
class ReadabilityCleaner extends BaseTextCleaner_1.BaseTextCleaner {
    constructor() {
        super('readability', 'Extracts the main content from web pages, removing navigation, ads, and other clutter', [ITextCleaner_1.TextFormat.HTML], {
            enabled: true,
            priority: 85,
            options: {
                debug: false,
    ...
    async performCleaning(input, config) {
        ...
        try {
            ...
            const dom = new jsdom_1.JSDOM(input, {
    ...
    async formatAsMarkdown(article) {
    ...
    calculateStatistics(original, cleaned) {
        const dom = new jsdom_1.JSDOM(original);
        ...
        return {
            ...
            custom: {
                ...
                footerRemoved,
                headerRemoved,
                reductionRatio: ((1 - cleaned.length / original.length) * 100).toFixed(2),
                extractionSuccess: cleaned.length > 100 ? 'true' : 'false'
            }
        };
    }
...
exports.ReadabilityCleaner = ReadabilityCleaner;
//# sourceMappingURL=ReadabilityCleaner.js.map