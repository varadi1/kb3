...
exports.ScraperParameterManager = exports.DoclingParameterValidator = exports.Crawl4AIParameterValidator = exports.PlaywrightParameterValidator = void 0;
/**
...
exports.PlaywrightParameterValidator = PlaywrightParameterValidator;
/**
...
exports.Crawl4AIParameterValidator = Crawl4AIParameterValidator;
/**
...
exports.DoclingParameterValidator = DoclingParameterValidator;
/**
...
class ScraperParameterManager {
    ...
    setBatchParameters(batch) {
        ...
        const validation = this.validateParameters(batch.configuration.scraperType, batch.configuration.parameters);
        if (!validation.valid) {
    ...
    validateParameters(scraperType, params) {
    ...
    mergeWithDefaults(scraperType, params) {
        const validator = this.validators.get(scraperType);
        if (!validator) {
     ...
     */
    getDefaultParameters(scraperType) {
        const validator = this.validators.get(scraperType);
        return validator ? validator.getDefaultParameters() : null;
    }
}
exports.ScraperParameterManager = ScraperParameterManager;
//# sourceMappingURL=ScraperParameterManager.js.map