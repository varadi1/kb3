...
exports.SmartHttpFetcher = void 0;
const HttpFetcher_1 = require("./HttpFetcher");
class SmartHttpFetcher extends HttpFetcher_1.HttpFetcher {
    jsRedirectPatterns;
    constructor(maxSize = 100 * 1024 * 1024, timeout = 30000, followRedirects = true, maxRedirects = 10) {
        ...
        this.jsRedirectPatterns = new Map([
            ...
            [
                ...
                (url) => url.replace('file-examples.com/wp-content/storage/', 'file-examples.com/storage/fe185d2bd268d64e19968c4/')
            ]
        ]);
    }
     ...
     */
    addRedirectPattern(pattern, transformer) {
        this.jsRedirectPatterns.set(pattern, transformer);
    }
}
exports.SmartHttpFetcher = SmartHttpFetcher;
//# sourceMappingURL=SmartHttpFetcher.js.map