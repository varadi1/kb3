...
export class ValidationUtils {
   ...
   */
  private static validateObjectSchema(obj: any, schema: ConfigSchema, path: string): void {
   ...
   */
  private static validateFieldValue(value: any, schema: FieldSchema, path: string): void {
    // Type validation
    ...
    // Array validations
    if ((schema.type as string) === 'array' && Array.isArray(value)) {
